...
while True:
    ...
    if option == '1':
        ...
        ergebnis_summe = int(zahl_eins) + int(zahl_zwei)
        print ('Das Ergebnis ist %s' % ergebnis_summe)
    if option == '2':
        zahl_eins = input('Die erste Zahl, bitte: ')
        zahl_zwei = input('Die zweite Zahl, bitte: ')
        ergebnis_differenz = int(zahl_eins) - int(zahl_zwei)
        print ('Das Ergbnis ist %s' % ergebnis_differenz)
    if option == '3':
        zahl_eins = input('Die erste Zahl, bitte: ')
        zahl_zwei = input('Die zweite Zahl, bitte: ')
        ergebnis_produkt = int(zahl_eins) * int(zahl_zwei)
        print ('Das Ergbnis ist %s' % ergebnis_produkt)
    if option == '4':
        zahl_eins = input('Die erste Zahl, bitte: ')
        zahl_zwei = input('Die zweite Zahl, bitte: ')
        ergebnis_dividieren = int(zahl_eins) / int(zahl_zwei)
